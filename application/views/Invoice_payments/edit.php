								...
								<div class="form-group">
									<select name="prj_id" class="form-control" id="prj_id"  required>
                                		...
                                		<?php foreach ($prj_list as $prj) { ?>
											<option value="<?php echo $prj['id']; ?>" <?php echo (($this->input->post('prj_id') ? ($this->input->post('prj_id') == $prj['id']) : ($invoice['prj_id'] == $prj['id']))) ? 'selected="selected"' : ""; ?> ><?php echo $prj['name']; ?></option>
                                		<?php } ?>
                           			</select> 
		 						</div>
						</div>
