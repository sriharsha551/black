<div class="layout-content">
	...
	<div class="container-fluid flex-grow-1 container-p-y">
		...
		<div class="card mb-4">
			...
			<div class="card-body"> 
				<div class="box-body">
				<form action="" method="post" name="proj_form">
				<div class="row clearfix"> 
            		...
            		<?php echo form_open('Exe_Tools/add'); ?>
					<div class="row clearfix">
                        ...
                        <div class="col-md-6" style="display:none">
                            ...
                            <div class='form-group'>
                                <input type="hidden" name="tool_id" value="<?php if(isset($selected)){echo $selected['id'];} ?>" class="form-control" id="tool_id" />
                                <span class="text-danger"><?php if($_SESSION['error']==true)echo form_error('tool_id');?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
							...
							<div class="form-group">
								<input type="number" name="qty" value="<?php if(isset($selected_tool))echo ($selected_tool['qty']); ?>" class="form-control" id="qty" />
