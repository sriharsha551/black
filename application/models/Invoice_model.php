...
class Invoice_model extends CI_Model
{
    ...
    {
        $this->db->select('t1.*,t2.name as invoice_status,t3.ponumber as order_num,t4.name as supplier,t5.name as cr_days,t5.days,t6.name as tax,t7.item_name as invoice_item, t8.name as prj_name');
        ...
        $this->db->join('prj_list as t8', 't1.prj_id = t8.id','inner');
        return $this->db->get_where('act_invoices t1',array('t1.deleted_at'=>null))->result_array();
    }
